...
use node_executor::ExtendHostFunctions;
use node_primitives::{BlockNumber, Hash};
use node_testing::keyring::*;
use sc_executor::{
	Externalities, RuntimeVersionOf, WasmExecutionMethod, WasmExecutor,
...
fn construct_block<E: Externalities>(
	executor: &WasmExecutor<ExtendHostFunctions>,
	ext: &mut E,
	number: BlockNumber,
	parent_hash: Hash,
...
fn bench_execute_block(c: &mut Criterion) {
	...
	let execution_methods = vec![WasmExecutionMethod::Compiled {
