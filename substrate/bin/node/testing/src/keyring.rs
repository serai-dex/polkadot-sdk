...
pub fn sign(xt: CheckedExtrinsic, spec_version: u32, genesis_hash: [u8; 32]) -> UncheckedExtrinsic {
	match xt.signed {
		Some((signed, extra)) => {
			let payload = (xt.function, extra.clone(), spec_version, genesis_hash, genesis_hash);
