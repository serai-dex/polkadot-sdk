...
fn session_keys(
	...
	SessionKeys { grandpa, babe, im_online, mixnet }
}

fn configure_accounts_for_staging_testnet(
) -> (Vec<(AccountId, AccountId, GrandpaId, BabeId, ImOnlineId, MixnetId)>, AccountId, Vec<AccountId>)
{
	#[rustfmt::skip]
...
pub fn authority_keys_from_seed(
	seed: &str,
) -> (AccountId, AccountId, GrandpaId, BabeId, ImOnlineId, MixnetId) {
	(
...
fn configure_accounts(
	initial_authorities: Vec<(AccountId, AccountId, GrandpaId, BabeId, ImOnlineId, MixnetId)>,
	initial_nominators: Vec<AccountId>,
	endowed_accounts: Option<Vec<AccountId>>,
	stash: Balance,
) -> (
	Vec<(AccountId, AccountId, GrandpaId, BabeId, ImOnlineId, MixnetId)>,
	Vec<AccountId>,
