...
pub fn start_session(session_index: SessionIndex) {
	for i in Session::current_index()..session_index {
		...
		System::reset_events();
		System::initialize(HeaderFor::<Test>::propose(i as u64 + 1, Default::default(), Default::default(), parent_hash, Default::default()));
...
pub fn initialize_block(number: u64, parent_hash: H256) {
	System::reset_events();
	System::initialize(HeaderFor::<Test>::propose(number, Default::default(), Default::default(), parent_hash, Default::default()));
}
